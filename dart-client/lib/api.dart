...
part 'model/get_generate_text_by_prompt400_response.dart';
part 'model/get_generate_text_by_prompt400_response_error.dart';
part 'model/get_generate_text_by_prompt400_response_error_message.dart';
part 'model/get_generate_text_by_prompt401_response.dart';
part 'model/get_generate_text_by_prompt401_response_error.dart';
part 'model/get_generate_text_by_prompt401_response_error_message.dart';
part 'model/get_generate_text_by_prompt402_response.dart';
part 'model/get_generate_text_by_prompt402_response_error.dart';
part 'model/get_generate_text_by_prompt402_response_error_message.dart';
part 'model/get_generate_text_by_prompt403_response.dart';
part 'model/get_generate_text_by_prompt403_response_error.dart';
part 'model/get_generate_text_by_prompt403_response_error_message.dart';
...
part 'model/post_generate_v1_audio_transcriptions200_response.dart';
