...
// tests for GetGenerateTextByPrompt400ResponseError
void main() {
  // final instance = GetGenerateTextByPrompt400ResponseError();

  group('test GetGenerateTextByPrompt400ResponseError', () {
    // String code
