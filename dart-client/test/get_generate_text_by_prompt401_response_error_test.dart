...
// tests for GetGenerateTextByPrompt401ResponseError
void main() {
  // final instance = GetGenerateTextByPrompt401ResponseError();

  group('test GetGenerateTextByPrompt401ResponseError', () {
    // String code
