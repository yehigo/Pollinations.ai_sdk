...
class GetGenerateTextByPrompt402Response(BaseModel):
    """
    GetGenerateTextByPrompt402Response
    """ # noqa: E501
    status: Union[StrictFloat, StrictInt]
    success: StrictBool
    error: GetGenerateTextByPrompt402ResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": GetGenerateTextByPrompt402ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
