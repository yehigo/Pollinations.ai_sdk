...
class PostGenerateV1ChatCompletions402Response(BaseModel):
    """
    PostGenerateV1ChatCompletions402Response
    """ # noqa: E501
    status: Union[StrictFloat, StrictInt]
    success: StrictBool
    error: PostGenerateV1ChatCompletions402ResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": PostGenerateV1ChatCompletions402ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
