...
class PostGenerateV1ChatCompletions403Response(BaseModel):
    """
    PostGenerateV1ChatCompletions403Response
    """ # noqa: E501
    status: Union[StrictFloat, StrictInt]
    success: StrictBool
    error: PostGenerateV1ChatCompletions403ResponseError
    __properties: ClassVar[List[str]] = ["status", "success", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": PostGenerateV1ChatCompletions403ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
