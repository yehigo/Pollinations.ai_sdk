...
POSTGENERATEV1CHATCOMPLETIONSREQUESTMESSAGESINNERANYOF1CONTENT_ANY_OF_SCHEMAS = ["List[MessageContentPart]", "str"]

class PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content(BaseModel):
    """
    ...
    anyof_schema_2_validator: Optional[Annotated[List[MessageContentPart], Field(min_length=1)]] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[List[MessageContentPart], str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "List[MessageContentPart]", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content with anyOf schemas: List[MessageContentPart], str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content with anyOf schemas: List[MessageContentPart], str. Details: " + ", ".join(error_messages))
        else:
            return instance
