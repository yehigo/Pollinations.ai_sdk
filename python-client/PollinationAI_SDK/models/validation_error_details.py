...
class ValidationErrorDetails(BaseModel):
    ...
    form_errors: List[StrictStr] = Field(alias="formErrors")
    field_errors: Dict[str, List[StrictStr]] = Field(alias="fieldErrors")
    __properties: ClassVar[List[str]] = ["name", "stack", "formErrors", "fieldErrors"]
