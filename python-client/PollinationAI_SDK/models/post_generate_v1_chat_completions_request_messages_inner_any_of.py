...
class PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf(BaseModel):
    """
    PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf
    """ # noqa: E501
    content: PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent
    role: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent.from_dict(obj["content"]) if obj.get("content") is not None else None,
            "role": obj.get("role"),
            "name": obj.get("name"),
