...
class CompletionUsageCompletionTokensDetails(BaseModel):
    ...
    """ # noqa: E501
    accepted_prediction_tokens: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]] = None
    audio_tokens: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]] = None
    reasoning_tokens: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]] = None
    rejected_prediction_tokens: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]] = None
