...
class GetGenerateTextByPrompt401Response(BaseModel):
    """
    GetGenerateTextByPrompt401Response
    """ # noqa: E501
    status: Union[StrictFloat, StrictInt]
    success: StrictBool
    error: GetGenerateTextByPrompt401ResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": GetGenerateTextByPrompt401ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
