...
class GetGenerateTextByPrompt400ResponseError(BaseModel):
    """
    GetGenerateTextByPrompt400ResponseError
    """ # noqa: E501
    code: StrictStr
    message: GetGenerateTextByPrompt400ResponseErrorMessage
    timestamp: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "message": GetGenerateTextByPrompt400ResponseErrorMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
