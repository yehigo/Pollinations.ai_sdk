...
class PostGenerateV1ChatCompletions200ResponsePromptFilterResultsInner(BaseModel):
    """
    PostGenerateV1ChatCompletions200ResponsePromptFilterResultsInner
    """ # noqa: E501
    prompt_index: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]
    content_filter_results: Optional[ContentFilterResult] = None
    __properties: ClassVar[List[str]] = ["prompt_index", "content_filter_results"]
