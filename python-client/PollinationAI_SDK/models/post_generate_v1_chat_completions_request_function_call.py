...
POSTGENERATEV1CHATCOMPLETIONSREQUESTFUNCTIONCALL_ANY_OF_SCHEMAS = ["PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf", "str"]

class PostGenerateV1ChatCompletionsRequestFunctionCall(BaseModel):
    """
    ...
    # data type: PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf
    anyof_schema_2_validator: Optional[PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = PostGenerateV1ChatCompletionsRequestFunctionCall.model_construct()
        error_messages = []
        ...
        # validate data type: PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf
        if not isinstance(v, PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in PostGenerateV1ChatCompletionsRequestFunctionCall with anyOf schemas: PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_2_validator: Optional[PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf] = None
        try:
            instance.actual_instance = PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PostGenerateV1ChatCompletionsRequestFunctionCall with anyOf schemas: PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf, str]]:
