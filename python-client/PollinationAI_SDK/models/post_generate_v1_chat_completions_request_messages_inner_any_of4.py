...
class PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf4(BaseModel):
    """
    ...
    tool_call_id: Optional[StrictStr]
    cache_control: Optional[CacheControl] = None
    __properties: ClassVar[List[str]] = ["role", "content", "tool_call_id", "cache_control"]
