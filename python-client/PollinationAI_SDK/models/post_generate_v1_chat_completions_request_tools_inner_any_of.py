...
class PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf(BaseModel):
    """
    PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf
    """ # noqa: E501
    type: StrictStr
    function: PostGenerateV1ChatCompletionsRequestToolsInnerAnyOfFunction
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "function": PostGenerateV1ChatCompletionsRequestToolsInnerAnyOfFunction.from_dict(obj["function"]) if obj.get("function") is not None else None
        })
        return _obj
