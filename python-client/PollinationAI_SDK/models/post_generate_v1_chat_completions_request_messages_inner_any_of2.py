...
class PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf2(BaseModel):
    """
    PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf2
    """ # noqa: E501
    content: Optional[PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content]
    role: StrictStr
