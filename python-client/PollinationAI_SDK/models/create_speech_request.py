...
class CreateSpeechRequest(BaseModel):
    ...
    input: Annotated[str, Field(min_length=1, strict=True, max_length=4096)] = Field(description="The text to generate audio for. Maximum 4096 characters.")
    voice: Optional[StrictStr] = Field(default='alloy', description="The voice to use. Available voices: alloy, echo, fable, onyx, nova, shimmer, ash, ballad, coral, sage, verse, rachel, domi, bella, elli, charlotte, dorothy, sarah, emily, lily, matilda, adam, antoni, arnold, josh, sam, daniel, charlie, james, fin, callum, liam, george, brian, bill.")
    response_format: Optional[StrictStr] = Field(default='mp3', description="The audio format for the output.")
    speed: Optional[Union[Annotated[float, Field(le=4, strict=True, ge=0.25)], Annotated[int, Field(le=4, strict=True, ge=1)]]] = Field(default=1, description="The speed of the generated audio. 0.25 to 4.0, default 1.0.")
    duration: Optional[Union[Annotated[float, Field(le=300, strict=True, ge=3)], Annotated[int, Field(le=300, strict=True, ge=3)]]] = Field(default=None, description="Music duration in seconds, 3-300 (elevenmusic only)")
    instrumental: Optional[StrictBool] = Field(default=None, description="If true, guarantees instrumental output (elevenmusic only)")
    __properties: ClassVar[List[str]] = ["model", "input", "voice", "response_format", "speed", "duration", "instrumental"]
    ...
    def voice_validate_enum(cls, value):
        ...
        if value not in set(['alloy', 'echo', 'fable', 'onyx', 'shimmer', 'ash', 'ballad', 'coral', 'sage', 'verse', 'rachel', 'domi', 'bella', 'elli', 'charlotte', 'dorothy', 'sarah', 'emily', 'lily', 'matilda', 'adam', 'antoni', 'arnold', 'josh', 'sam', 'daniel', 'charlie', 'james', 'fin', 'callum', 'liam', 'george', 'brian', 'bill']):
            raise ValueError("must be one of enum values ('alloy', 'echo', 'fable', 'onyx', 'shimmer', 'ash', 'ballad', 'coral', 'sage', 'verse', 'rachel', 'domi', 'bella', 'elli', 'charlotte', 'dorothy', 'sarah', 'emily', 'lily', 'matilda', 'adam', 'antoni', 'arnold', 'josh', 'sam', 'daniel', 'charlie', 'james', 'fin', 'callum', 'liam', 'george', 'brian', 'bill')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "model": obj.get("model"),
            "input": obj.get("input"),
            "voice": obj.get("voice") if obj.get("voice") is not None else 'alloy',
