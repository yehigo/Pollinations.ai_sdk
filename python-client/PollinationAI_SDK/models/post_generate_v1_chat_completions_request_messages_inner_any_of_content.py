...
POSTGENERATEV1CHATCOMPLETIONSREQUESTMESSAGESINNERANYOFCONTENT_ANY_OF_SCHEMAS = ["List[MessageContentPart]", "str"]

class PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent with anyOf schemas: List[MessageContentPart], str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent with anyOf schemas: List[MessageContentPart], str. Details: " + ", ".join(error_messages))
        else:
            return instance
