...
class PostGenerateV1ChatCompletions400ResponseError(BaseModel):
    """
    PostGenerateV1ChatCompletions400ResponseError
    """ # noqa: E501
    code: StrictStr
    message: PostGenerateV1ChatCompletions400ResponseErrorMessage
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['BAD_REQUEST']):
            raise ValueError("must be one of enum values ('BAD_REQUEST')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "message": PostGenerateV1ChatCompletions400ResponseErrorMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
            "timestamp": obj.get("timestamp"),
            "details": ValidationErrorDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,
