...
class PostGenerateV1ChatCompletions200ResponseChoicesInnerLogprobsContentInner(BaseModel):
    """
    ...
    bytes: Optional[List[Annotated[int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)]]]
    top_logprobs: List[PostGenerateV1ChatCompletions200ResponseChoicesInnerLogprobsContentInnerTopLogprobsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bytes": obj.get("bytes"),
            "top_logprobs": [PostGenerateV1ChatCompletions200ResponseChoicesInnerLogprobsContentInnerTopLogprobsInner.from_dict(_item) for _item in obj["top_logprobs"]] if obj.get("top_logprobs") is not None else None
        })
        return _obj
