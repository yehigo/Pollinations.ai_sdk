...
class GetGenerateTextPrompt402Response(BaseModel):
    """
    GetGenerateTextPrompt402Response
    """ # noqa: E501
    status: Union[StrictFloat, StrictInt]
    success: StrictBool
    error: GetGenerateTextPrompt402ResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": GetGenerateTextPrompt402ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
