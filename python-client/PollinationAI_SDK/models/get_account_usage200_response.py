...
class GetAccountUsage200Response(BaseModel):
    """
    GetAccountUsage200Response
    """ # noqa: E501
    usage: List[GetAccountUsage200ResponseUsageInner] = Field(description="Array of usage records")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "usage": [GetAccountUsage200ResponseUsageInner.from_dict(_item) for _item in obj["usage"]] if obj.get("usage") is not None else None,
            "count": obj.get("count")
        })
        return _obj
