...
class GetGenerateTextPrompt403Response(BaseModel):
    """
    GetGenerateTextPrompt403Response
    """ # noqa: E501
    status: Union[StrictFloat, StrictInt]
    success: StrictBool
    error: GetGenerateTextPrompt403ResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": GetGenerateTextPrompt403ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
