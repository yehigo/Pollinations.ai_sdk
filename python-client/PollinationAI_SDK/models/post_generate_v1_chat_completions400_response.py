...
class PostGenerateV1ChatCompletions400Response(BaseModel):
    """
    PostGenerateV1ChatCompletions400Response
    """ # noqa: E501
    status: Union[StrictFloat, StrictInt]
    success: StrictBool
    error: PostGenerateV1ChatCompletions400ResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": PostGenerateV1ChatCompletions400ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
