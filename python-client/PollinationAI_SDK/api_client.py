...
from PollinationAI_SDK.configuration import Configuration
from PollinationAI_SDK.api_response import ApiResponse, T as ApiResponseT
import PollinationAI_SDK.models
from PollinationAI_SDK import rest
from PollinationAI_SDK.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(PollinationAI_SDK.models, klass)
