...
class MessageContentPartAnyOf(BaseModel):
    """
    MessageContentPartAnyOf
    """ # noqa: E501
    type: StrictStr
    video_url: MessageContentPartAnyOfVideoUrl
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "video_url": MessageContentPartAnyOfVideoUrl.from_dict(obj["video_url"]) if obj.get("video_url") is not None else None
        })
        return _obj
