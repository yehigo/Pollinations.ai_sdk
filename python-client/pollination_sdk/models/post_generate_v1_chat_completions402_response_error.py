...
class PostGenerateV1ChatCompletions402ResponseError(BaseModel):
    """
    PostGenerateV1ChatCompletions402ResponseError
    """ # noqa: E501
    code: StrictStr
    message: PostGenerateV1ChatCompletions402ResponseErrorMessage
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PAYMENT_REQUIRED']):
            raise ValueError("must be one of enum values ('PAYMENT_REQUIRED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "message": PostGenerateV1ChatCompletions402ResponseErrorMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
