...
class MessageContentPartAnyOf2(BaseModel):
    """
    MessageContentPartAnyOf2
    """ # noqa: E501
    type: StrictStr
    file: MessageContentPartAnyOf2File
    cache_control: Optional[CacheControl] = None
    __properties: ClassVar[List[str]] = ["type", "file", "cache_control"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "file": MessageContentPartAnyOf2File.from_dict(obj["file"]) if obj.get("file") is not None else None,
