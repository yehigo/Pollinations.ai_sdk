...
class PostGenerateV1ChatCompletionsRequestAudio(BaseModel):
    """
    ...
    def voice_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['alloy', 'echo', 'fable', 'onyx', 'shimmer', 'coral', 'verse', 'ballad', 'ash', 'sage', 'amuch', 'dan']):
            raise ValueError("must be one of enum values ('alloy', 'echo', 'fable', 'onyx', 'shimmer', 'coral', 'verse', 'ballad', 'ash', 'sage', 'amuch', 'dan')")
        return value
