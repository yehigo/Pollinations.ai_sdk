...
class PostGenerateV1ChatCompletions200ResponseChoicesInner(BaseModel):
    """
    PostGenerateV1ChatCompletions200ResponseChoicesInner
    """ # noqa: E501
    finish_reason: Optional[StrictStr] = None
    index: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]] = None
    message: Optional[PostGenerateV1ChatCompletions200ResponseChoicesInnerMessage] = None
    logprobs: Optional[PostGenerateV1ChatCompletions200ResponseChoicesInnerLogprobs] = None
    content_filter_results: Optional[ContentFilterResult] = None
    __properties: ClassVar[List[str]] = ["finish_reason", "index", "message", "logprobs", "content_filter_results"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of content_filter_results
        if self.content_filter_results:
            _dict['content_filter_results'] = self.content_filter_results.to_dict()
        ...
        # set to None if content_filter_results (nullable) is None
        # and model_fields_set contains the field
        if self.content_filter_results is None and "content_filter_results" in self.model_fields_set:
            _dict['content_filter_results'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "index": obj.get("index"),
            "message": PostGenerateV1ChatCompletions200ResponseChoicesInnerMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
            "logprobs": PostGenerateV1ChatCompletions200ResponseChoicesInnerLogprobs.from_dict(obj["logprobs"]) if obj.get("logprobs") is not None else None,
            "content_filter_results": ContentFilterResult.from_dict(obj["content_filter_results"]) if obj.get("content_filter_results") is not None else None
        })
        return _obj
