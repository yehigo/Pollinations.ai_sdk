...
class GetGenerateTextPrompt401ResponseError(BaseModel):
    """
    GetGenerateTextPrompt401ResponseError
    """ # noqa: E501
    code: StrictStr
    message: GetGenerateTextPrompt401ResponseErrorMessage
    timestamp: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "message": GetGenerateTextPrompt401ResponseErrorMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
