...
class GetGenerateV1Models500ResponseError(BaseModel):
    """
    GetGenerateV1Models500ResponseError
    """ # noqa: E501
    code: StrictStr
    message: GetGenerateV1Models500ResponseErrorMessage
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "message": GetGenerateV1Models500ResponseErrorMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
