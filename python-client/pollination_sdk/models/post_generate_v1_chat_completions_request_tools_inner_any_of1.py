...
class PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf1(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['code_execution', 'google_search', 'google_maps', 'url_context', 'computer_use', 'file_search']):
            raise ValueError("must be one of enum values ('code_execution', 'google_search', 'google_maps', 'url_context', 'computer_use', 'file_search')")
        return value
