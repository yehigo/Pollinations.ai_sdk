...
class PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageAudio(BaseModel):
    """
    PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageAudio
    """ # noqa: E501
    transcript: Optional[StrictStr]
    data: Optional[StrictStr]
    id: Optional[StrictStr] = None
    expires_at: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)]] = None
    __properties: ClassVar[List[str]] = ["transcript", "data", "id", "expires_at"]
