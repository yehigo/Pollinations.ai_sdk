...
class PostGenerateV1ChatCompletions401ResponseError(BaseModel):
    """
    PostGenerateV1ChatCompletions401ResponseError
    """ # noqa: E501
    code: StrictStr
    message: PostGenerateV1ChatCompletions401ResponseErrorMessage
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "message": PostGenerateV1ChatCompletions401ResponseErrorMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
