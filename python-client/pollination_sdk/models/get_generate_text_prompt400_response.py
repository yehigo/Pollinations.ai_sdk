...
class GetGenerateTextPrompt400Response(BaseModel):
    """
    GetGenerateTextPrompt400Response
    """ # noqa: E501
    status: Union[StrictFloat, StrictInt]
    success: StrictBool
    error: GetGenerateTextPrompt400ResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": GetGenerateTextPrompt400ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
