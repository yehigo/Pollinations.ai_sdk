...
class GetAccountBalance200Response(BaseModel):
    """
    GetAccountBalance200Response
    """ # noqa: E501
    balance: Union[StrictFloat, StrictInt] = Field(description="Remaining pollen balance (combines tier, pack, and crypto balances)")
