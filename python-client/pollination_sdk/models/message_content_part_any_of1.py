...
class MessageContentPartAnyOf1(BaseModel):
    """
    MessageContentPartAnyOf1
    """ # noqa: E501
    type: StrictStr
    input_audio: MessageContentPartAnyOf1InputAudio
    cache_control: Optional[CacheControl] = None
    __properties: ClassVar[List[str]] = ["type", "input_audio", "cache_control"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "input_audio": MessageContentPartAnyOf1InputAudio.from_dict(obj["input_audio"]) if obj.get("input_audio") is not None else None,
