...
class PostGenerateV1ChatCompletions200ResponseChoicesInnerLogprobs(BaseModel):
    """
    PostGenerateV1ChatCompletions200ResponseChoicesInnerLogprobs
    """ # noqa: E501
    content: Optional[List[PostGenerateV1ChatCompletions200ResponseChoicesInnerLogprobsContentInner]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [PostGenerateV1ChatCompletions200ResponseChoicesInnerLogprobsContentInner.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
