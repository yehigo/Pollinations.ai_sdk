...
POSTGENERATEV1CHATCOMPLETIONSREQUESTTOOLCHOICE_ANY_OF_SCHEMAS = ["PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf", "str"]

class PostGenerateV1ChatCompletionsRequestToolChoice(BaseModel):
    """
    ...
    # data type: PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf
    anyof_schema_2_validator: Optional[PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = PostGenerateV1ChatCompletionsRequestToolChoice.model_construct()
        error_messages = []
        ...
        # validate data type: PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf
        if not isinstance(v, PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in PostGenerateV1ChatCompletionsRequestToolChoice with anyOf schemas: PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_2_validator: Optional[PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf] = None
        try:
            instance.actual_instance = PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PostGenerateV1ChatCompletionsRequestToolChoice with anyOf schemas: PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf, str]]:
