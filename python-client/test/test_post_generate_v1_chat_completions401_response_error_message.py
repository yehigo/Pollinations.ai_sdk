...
class TestPostGenerateV1ChatCompletions401ResponseErrorMessage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletions401ResponseErrorMessage:
        """Test PostGenerateV1ChatCompletions401ResponseErrorMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletions401ResponseErrorMessage`
        """
        model = PostGenerateV1ChatCompletions401ResponseErrorMessage()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletions401ResponseErrorMessage(self):
        """Test PostGenerateV1ChatCompletions401ResponseErrorMessage"""
