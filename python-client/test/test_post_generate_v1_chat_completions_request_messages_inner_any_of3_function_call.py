...
class TestPostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3FunctionCall(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3FunctionCall unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3FunctionCall:
        """Test PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3FunctionCall
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3FunctionCall`
        """
        model = PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3FunctionCall()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3FunctionCall(self):
        """Test PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3FunctionCall"""
