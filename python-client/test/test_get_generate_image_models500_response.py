...
class TestGetGenerateImageModels500Response(unittest.TestCase):
    """GetGenerateImageModels500Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateImageModels500Response:
        """Test GetGenerateImageModels500Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateImageModels500Response`
        """
        model = GetGenerateImageModels500Response()
        if include_optional:
            return GetGenerateImageModels500Response(
                status = 500,
                success = false,
                error = PollinationAI_SDK.models.get_generate_image_models_500_response_error.getGenerateImageModels_500_response_error(
                    code = 'INTERNAL_ERROR', 
                    message = null, 
                    timestamp = '', 
    ...
    def testGetGenerateImageModels500Response(self):
        """Test GetGenerateImageModels500Response"""
