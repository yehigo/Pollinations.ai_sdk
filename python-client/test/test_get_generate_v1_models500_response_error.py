...
class TestGetGenerateV1Models500ResponseError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateV1Models500ResponseError:
        """Test GetGenerateV1Models500ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateV1Models500ResponseError`
        """
        model = GetGenerateV1Models500ResponseError()
        if include_optional:
    ...
    def testGetGenerateV1Models500ResponseError(self):
        """Test GetGenerateV1Models500ResponseError"""
