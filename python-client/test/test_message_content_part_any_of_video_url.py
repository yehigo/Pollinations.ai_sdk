...
class TestMessageContentPartAnyOfVideoUrl(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MessageContentPartAnyOfVideoUrl:
        """Test MessageContentPartAnyOfVideoUrl
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageContentPartAnyOfVideoUrl`
        """
        model = MessageContentPartAnyOfVideoUrl()
        if include_optional:
    ...
    def testMessageContentPartAnyOfVideoUrl(self):
        """Test MessageContentPartAnyOfVideoUrl"""
