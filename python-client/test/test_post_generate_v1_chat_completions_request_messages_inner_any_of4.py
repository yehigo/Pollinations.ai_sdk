...
class TestPostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf4(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf4:
        """Test PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf4`
        """
        model = PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf4()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf4(self):
        """Test PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf4"""
