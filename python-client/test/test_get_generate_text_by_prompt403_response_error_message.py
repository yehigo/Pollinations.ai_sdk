...
class TestGetGenerateTextByPrompt403ResponseErrorMessage(unittest.TestCase):
    """GetGenerateTextByPrompt403ResponseErrorMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextByPrompt403ResponseErrorMessage:
        """Test GetGenerateTextByPrompt403ResponseErrorMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextByPrompt403ResponseErrorMessage`
        """
        model = GetGenerateTextByPrompt403ResponseErrorMessage()
        if include_optional:
    ...
    def testGetGenerateTextByPrompt403ResponseErrorMessage(self):
        """Test GetGenerateTextByPrompt403ResponseErrorMessage"""
