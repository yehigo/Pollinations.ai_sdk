...
class TestGetGenerateTextPrompt403ResponseErrorMessage(unittest.TestCase):
    """GetGenerateTextPrompt403ResponseErrorMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextPrompt403ResponseErrorMessage:
        """Test GetGenerateTextPrompt403ResponseErrorMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextPrompt403ResponseErrorMessage`
        """
        model = GetGenerateTextPrompt403ResponseErrorMessage()
        if include_optional:
    ...
    def testGetGenerateTextPrompt403ResponseErrorMessage(self):
        """Test GetGenerateTextPrompt403ResponseErrorMessage"""
