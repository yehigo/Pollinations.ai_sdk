...
class TestGetGenerateTextByPrompt400ResponseErrorMessage(unittest.TestCase):
    """GetGenerateTextByPrompt400ResponseErrorMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextByPrompt400ResponseErrorMessage:
        """Test GetGenerateTextByPrompt400ResponseErrorMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextByPrompt400ResponseErrorMessage`
        """
        model = GetGenerateTextByPrompt400ResponseErrorMessage()
        if include_optional:
    ...
    def testGetGenerateTextByPrompt400ResponseErrorMessage(self):
        """Test GetGenerateTextByPrompt400ResponseErrorMessage"""
