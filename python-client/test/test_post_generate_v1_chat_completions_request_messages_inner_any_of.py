...
class TestPostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf:
        """Test PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf`
        """
        model = PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf(self):
        """Test PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf"""
