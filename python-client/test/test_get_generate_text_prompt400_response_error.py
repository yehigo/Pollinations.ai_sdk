...
class TestGetGenerateTextPrompt400ResponseError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateTextPrompt400ResponseError:
        """Test GetGenerateTextPrompt400ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextPrompt400ResponseError`
        """
        model = GetGenerateTextPrompt400ResponseError()
        if include_optional:
    ...
    def testGetGenerateTextPrompt400ResponseError(self):
        """Test GetGenerateTextPrompt400ResponseError"""
