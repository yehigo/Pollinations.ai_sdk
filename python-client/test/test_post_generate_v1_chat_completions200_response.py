    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletions200Response:
        ...
        if include_optional:
            return PostGenerateV1ChatCompletions200Response(
                id = '',
                choices = [
                    PollinationAI_SDK.models.post_generate_v1_chat_completions_200_response_choices_inner.postGenerateV1ChatCompletions_200_response_choices_inner(
                        finish_reason = '', 
                        index = 0, 
                ...
                prompt_filter_results = [
                    PollinationAI_SDK.models.post_generate_v1_chat_completions_200_response_prompt_filter_results_inner.postGenerateV1ChatCompletions_200_response_prompt_filter_results_inner(
                        prompt_index = 0, 
                ...
                usage = PollinationAI_SDK.models.completion_usage.CompletionUsage(
                    completion_tokens = 0, 
