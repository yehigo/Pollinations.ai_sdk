...
class TestGetGenerateTextByPrompt400Response(unittest.TestCase):
    """GetGenerateTextByPrompt400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextByPrompt400Response:
        """Test GetGenerateTextByPrompt400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextByPrompt400Response`
        """
        model = GetGenerateTextByPrompt400Response()
        if include_optional:
            return GetGenerateTextByPrompt400Response(
                status = 400,
                success = false,
                error = PollinationAI_SDK.models.get_generate_text_by_prompt_400_response_error.getGenerateTextByPrompt_400_response_error(
                    code = 'BAD_REQUEST', 
                    message = null, 
                    timestamp = '', 
    ...
    def testGetGenerateTextByPrompt400Response(self):
        """Test GetGenerateTextByPrompt400Response"""
