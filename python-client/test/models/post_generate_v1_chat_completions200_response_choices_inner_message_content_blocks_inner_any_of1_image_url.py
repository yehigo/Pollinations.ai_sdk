...
class PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInnerAnyOf1ImageUrl(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["url", "detail", "mime_type"]
