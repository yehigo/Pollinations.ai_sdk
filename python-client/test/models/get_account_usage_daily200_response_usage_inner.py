...
class GetAccountUsageDaily200ResponseUsageInner(BaseModel):
    """
    GetAccountUsageDaily200ResponseUsageInner
    """ # noqa: E501
    var_date: StrictStr = Field(description="Date (YYYY-MM-DD format)", alias="date")
    model: Optional[StrictStr]
    meter_source: Optional[StrictStr]
    requests: Union[StrictFloat, StrictInt] = Field(description="Number of requests")
    cost_usd: Union[StrictFloat, StrictInt] = Field(description="Total cost in USD")
    __properties: ClassVar[List[str]] = ["date", "model", "meter_source", "requests", "cost_usd"]
