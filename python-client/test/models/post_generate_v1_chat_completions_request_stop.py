...
POSTGENERATEV1CHATCOMPLETIONSREQUESTSTOP_ANY_OF_SCHEMAS = ["List[Optional[str]]", "str"]

class PostGenerateV1ChatCompletionsRequestStop(BaseModel):
    """
    ...
    anyof_schema_2_validator: Optional[Annotated[List[Optional[StrictStr]], Field(min_length=1, max_length=4)]] = None
    if TYPE_CHECKING:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = PostGenerateV1ChatCompletionsRequestStop.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in PostGenerateV1ChatCompletionsRequestStop with anyOf schemas: List[Optional[str]], str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PostGenerateV1ChatCompletionsRequestStop with anyOf schemas: List[Optional[str]], str. Details: " + ", ".join(error_messages))
        else:
            return instance
