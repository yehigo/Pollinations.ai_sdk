...
class GetGenerateV1Models500Response(BaseModel):
    """
    GetGenerateV1Models500Response
    """ # noqa: E501
    status: Union[StrictFloat, StrictInt]
    success: StrictBool
    error: GetGenerateV1Models500ResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": GetGenerateV1Models500ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
