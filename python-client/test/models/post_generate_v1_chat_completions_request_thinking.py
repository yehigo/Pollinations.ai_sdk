...
class PostGenerateV1ChatCompletionsRequestThinking(BaseModel):
    """
    PostGenerateV1ChatCompletionsRequestThinking
    """ # noqa: E501
    type: Optional[StrictStr] = 'disabled'
    budget_tokens: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=1)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'disabled',
