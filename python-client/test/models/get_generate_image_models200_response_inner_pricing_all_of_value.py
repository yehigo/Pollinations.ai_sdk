...
GETGENERATEIMAGEMODELS200RESPONSEINNERPRICINGALLOFVALUE_ANY_OF_SCHEMAS = ["float", "str"]

class GetGenerateImageModels200ResponseInnerPricingAllOfValue(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = GetGenerateImageModels200ResponseInnerPricingAllOfValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in GetGenerateImageModels200ResponseInnerPricingAllOfValue with anyOf schemas: float, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into GetGenerateImageModels200ResponseInnerPricingAllOfValue with anyOf schemas: float, str. Details: " + ", ".join(error_messages))
        else:
            return instance
