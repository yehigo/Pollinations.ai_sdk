...
class PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInner(BaseModel):
    """
    PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInner
    """ # noqa: E501
    id: StrictStr
    type: StrictStr
    function: PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInnerFunction
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "function": PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInnerFunction.from_dict(obj["function"]) if obj.get("function") is not None else None
        })
        return _obj
