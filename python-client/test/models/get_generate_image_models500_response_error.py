...
class GetGenerateImageModels500ResponseError(BaseModel):
    """
    GetGenerateImageModels500ResponseError
    """ # noqa: E501
    code: StrictStr
    message: GetGenerateImageModels500ResponseErrorMessage
    timestamp: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "message": GetGenerateImageModels500ResponseErrorMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
