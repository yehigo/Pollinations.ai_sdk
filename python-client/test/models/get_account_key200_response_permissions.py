...
class GetAccountKey200ResponsePermissions(BaseModel):
    """
    API key permissions
    """ # noqa: E501
    models: Optional[List[Optional[StrictStr]]]
    account: Optional[List[StrictStr]]
    __properties: ClassVar[List[str]] = ["models", "account"]
