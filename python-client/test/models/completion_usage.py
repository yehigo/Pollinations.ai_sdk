...
class CompletionUsage(BaseModel):
    ...
    CompletionUsage
    """ # noqa: E501
    completion_tokens: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]
    completion_tokens_details: Optional[CompletionUsageCompletionTokensDetails] = None
    prompt_tokens: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]
    prompt_tokens_details: Optional[CompletionUsagePromptTokensDetails] = None
    total_tokens: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["completion_tokens", "completion_tokens_details", "prompt_tokens", "prompt_tokens_details", "total_tokens"]
