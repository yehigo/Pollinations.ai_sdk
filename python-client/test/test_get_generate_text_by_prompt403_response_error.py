...
class TestGetGenerateTextByPrompt403ResponseError(unittest.TestCase):
    """GetGenerateTextByPrompt403ResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextByPrompt403ResponseError:
        """Test GetGenerateTextByPrompt403ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextByPrompt403ResponseError`
        """
        model = GetGenerateTextByPrompt403ResponseError()
        if include_optional:
    ...
    def testGetGenerateTextByPrompt403ResponseError(self):
        """Test GetGenerateTextByPrompt403ResponseError"""
