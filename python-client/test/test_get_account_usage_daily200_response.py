...
class TestGetAccountUsageDaily200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAccountUsageDaily200Response:
        """Test GetAccountUsageDaily200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccountUsageDaily200Response`
        """
        model = GetAccountUsageDaily200Response()
        if include_optional:
    ...
    def testGetAccountUsageDaily200Response(self):
        """Test GetAccountUsageDaily200Response"""
