...
class TestPostGenerateV1ChatCompletionsRequestToolsInnerAnyOfFunction(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestToolsInnerAnyOfFunction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestToolsInnerAnyOfFunction:
        """Test PostGenerateV1ChatCompletionsRequestToolsInnerAnyOfFunction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestToolsInnerAnyOfFunction`
        """
        model = PostGenerateV1ChatCompletionsRequestToolsInnerAnyOfFunction()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestToolsInnerAnyOfFunction(self):
        """Test PostGenerateV1ChatCompletionsRequestToolsInnerAnyOfFunction"""
