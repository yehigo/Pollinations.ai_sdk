...
class TestGetGenerateImageModels200ResponseInnerPricing(unittest.TestCase):
    """GetGenerateImageModels200ResponseInnerPricing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateImageModels200ResponseInnerPricing:
        """Test GetGenerateImageModels200ResponseInnerPricing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateImageModels200ResponseInnerPricing`
        """
        model = GetGenerateImageModels200ResponseInnerPricing()
        if include_optional:
    ...
    def testGetGenerateImageModels200ResponseInnerPricing(self):
        """Test GetGenerateImageModels200ResponseInnerPricing"""
