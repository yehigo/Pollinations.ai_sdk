...
class TestGetGenerateTextByPrompt402ResponseErrorMessage(unittest.TestCase):
    """GetGenerateTextByPrompt402ResponseErrorMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextByPrompt402ResponseErrorMessage:
        """Test GetGenerateTextByPrompt402ResponseErrorMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextByPrompt402ResponseErrorMessage`
        """
        model = GetGenerateTextByPrompt402ResponseErrorMessage()
        if include_optional:
    ...
    def testGetGenerateTextByPrompt402ResponseErrorMessage(self):
        """Test GetGenerateTextByPrompt402ResponseErrorMessage"""
