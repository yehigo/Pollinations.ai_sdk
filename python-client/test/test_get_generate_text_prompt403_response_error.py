...
class TestGetGenerateTextPrompt403ResponseError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateTextPrompt403ResponseError:
        """Test GetGenerateTextPrompt403ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextPrompt403ResponseError`
        """
        model = GetGenerateTextPrompt403ResponseError()
        if include_optional:
    ...
    def testGetGenerateTextPrompt403ResponseError(self):
        """Test GetGenerateTextPrompt403ResponseError"""
