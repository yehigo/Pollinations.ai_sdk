...
class TestGetGenerateTextByPrompt400ResponseError(unittest.TestCase):
    """GetGenerateTextByPrompt400ResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextByPrompt400ResponseError:
        """Test GetGenerateTextByPrompt400ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextByPrompt400ResponseError`
        """
        model = GetGenerateTextByPrompt400ResponseError()
        if include_optional:
    ...
    def testGetGenerateTextByPrompt400ResponseError(self):
        """Test GetGenerateTextByPrompt400ResponseError"""
