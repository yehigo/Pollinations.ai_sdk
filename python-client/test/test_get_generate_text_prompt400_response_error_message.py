...
class TestGetGenerateTextPrompt400ResponseErrorMessage(unittest.TestCase):
    """GetGenerateTextPrompt400ResponseErrorMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextPrompt400ResponseErrorMessage:
        """Test GetGenerateTextPrompt400ResponseErrorMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextPrompt400ResponseErrorMessage`
        """
        model = GetGenerateTextPrompt400ResponseErrorMessage()
        if include_optional:
    ...
    def testGetGenerateTextPrompt400ResponseErrorMessage(self):
        """Test GetGenerateTextPrompt400ResponseErrorMessage"""
