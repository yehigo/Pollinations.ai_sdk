...
class TestGetGenerateImageModels200ResponseInnerPricingAllOfValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateImageModels200ResponseInnerPricingAllOfValue:
        """Test GetGenerateImageModels200ResponseInnerPricingAllOfValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateImageModels200ResponseInnerPricingAllOfValue`
        """
        model = GetGenerateImageModels200ResponseInnerPricingAllOfValue()
        if include_optional:
    ...
    def testGetGenerateImageModels200ResponseInnerPricingAllOfValue(self):
        """Test GetGenerateImageModels200ResponseInnerPricingAllOfValue"""
