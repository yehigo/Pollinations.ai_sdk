...
class TestPostGenerateV1ChatCompletionsRequestAudio(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestAudio:
        """Test PostGenerateV1ChatCompletionsRequestAudio
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestAudio`
        """
        model = PostGenerateV1ChatCompletionsRequestAudio()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestAudio(self):
        """Test PostGenerateV1ChatCompletionsRequestAudio"""
