...
class TestPostGenerateV1ChatCompletionsRequestResponseFormat(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestResponseFormat:
        """Test PostGenerateV1ChatCompletionsRequestResponseFormat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestResponseFormat`
        """
        model = PostGenerateV1ChatCompletionsRequestResponseFormat()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestResponseFormat(self):
        """Test PostGenerateV1ChatCompletionsRequestResponseFormat"""
