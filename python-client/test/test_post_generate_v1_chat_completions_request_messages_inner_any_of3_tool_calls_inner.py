...
class TestPostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3ToolCallsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3ToolCallsInner:
        """Test PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3ToolCallsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3ToolCallsInner`
        """
        model = PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3ToolCallsInner()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3ToolCallsInner(self):
        """Test PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf3ToolCallsInner"""
