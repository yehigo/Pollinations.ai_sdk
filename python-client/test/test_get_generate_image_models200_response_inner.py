...
class TestGetGenerateImageModels200ResponseInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateImageModels200ResponseInner:
        """Test GetGenerateImageModels200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateImageModels200ResponseInner`
        """
        model = GetGenerateImageModels200ResponseInner()
        if include_optional:
    ...
    def testGetGenerateImageModels200ResponseInner(self):
        """Test GetGenerateImageModels200ResponseInner"""
