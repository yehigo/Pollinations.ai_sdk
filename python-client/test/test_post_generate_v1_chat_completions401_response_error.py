...
class TestPostGenerateV1ChatCompletions401ResponseError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletions401ResponseError:
        """Test PostGenerateV1ChatCompletions401ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletions401ResponseError`
        """
        model = PostGenerateV1ChatCompletions401ResponseError()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletions401ResponseError(self):
        """Test PostGenerateV1ChatCompletions401ResponseError"""
