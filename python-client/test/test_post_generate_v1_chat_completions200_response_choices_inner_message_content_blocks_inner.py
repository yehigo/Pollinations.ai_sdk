...
class TestPostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInner:
        """Test PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInner`
        """
        model = PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInner()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInner(self):
        """Test PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInner"""
