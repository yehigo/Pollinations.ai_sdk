...
class TestPostGenerateV1ChatCompletionsRequestStreamOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestStreamOptions:
        """Test PostGenerateV1ChatCompletionsRequestStreamOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestStreamOptions`
        """
        model = PostGenerateV1ChatCompletionsRequestStreamOptions()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestStreamOptions(self):
        """Test PostGenerateV1ChatCompletionsRequestStreamOptions"""
