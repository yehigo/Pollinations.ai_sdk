...
class TestMessageContentPartAnyOf2File(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MessageContentPartAnyOf2File:
        """Test MessageContentPartAnyOf2File
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageContentPartAnyOf2File`
        """
        model = MessageContentPartAnyOf2File()
        if include_optional:
    ...
    def testMessageContentPartAnyOf2File(self):
        """Test MessageContentPartAnyOf2File"""
