...
class TestPostGenerateV1ChatCompletionsRequestToolChoice(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestToolChoice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestToolChoice:
        """Test PostGenerateV1ChatCompletionsRequestToolChoice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestToolChoice`
        """
        model = PostGenerateV1ChatCompletionsRequestToolChoice()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestToolChoice(self):
        """Test PostGenerateV1ChatCompletionsRequestToolChoice"""
