...
class TestGetGenerateImageModels500ResponseError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateImageModels500ResponseError:
        """Test GetGenerateImageModels500ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateImageModels500ResponseError`
        """
        model = GetGenerateImageModels500ResponseError()
        if include_optional:
    ...
    def testGetGenerateImageModels500ResponseError(self):
        """Test GetGenerateImageModels500ResponseError"""
