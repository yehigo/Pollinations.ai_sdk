...
class TestPostGenerateV1ChatCompletionsRequestToolChoiceAnyOfFunction(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestToolChoiceAnyOfFunction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestToolChoiceAnyOfFunction:
        """Test PostGenerateV1ChatCompletionsRequestToolChoiceAnyOfFunction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestToolChoiceAnyOfFunction`
        """
        model = PostGenerateV1ChatCompletionsRequestToolChoiceAnyOfFunction()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestToolChoiceAnyOfFunction(self):
        """Test PostGenerateV1ChatCompletionsRequestToolChoiceAnyOfFunction"""
