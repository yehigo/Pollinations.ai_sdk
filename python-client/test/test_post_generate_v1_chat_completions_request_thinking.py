...
class TestPostGenerateV1ChatCompletionsRequestThinking(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestThinking unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestThinking:
        """Test PostGenerateV1ChatCompletionsRequestThinking
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestThinking`
        """
        model = PostGenerateV1ChatCompletionsRequestThinking()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestThinking(self):
        """Test PostGenerateV1ChatCompletionsRequestThinking"""
