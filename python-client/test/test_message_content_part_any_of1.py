...
class TestMessageContentPartAnyOf1(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MessageContentPartAnyOf1:
        """Test MessageContentPartAnyOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageContentPartAnyOf1`
        """
        model = MessageContentPartAnyOf1()
        if include_optional:
    ...
    def testMessageContentPartAnyOf1(self):
        """Test MessageContentPartAnyOf1"""
