...
class TestPostGenerateV1ChatCompletions400Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletions400Response:
        """Test PostGenerateV1ChatCompletions400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletions400Response`
        """
        model = PostGenerateV1ChatCompletions400Response()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletions400Response(self):
        """Test PostGenerateV1ChatCompletions400Response"""
