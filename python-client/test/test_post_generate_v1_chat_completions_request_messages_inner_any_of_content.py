...
class TestPostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent:
        """Test PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent`
        """
        model = PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent(self):
        """Test PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOfContent"""
