...
class TestPostGenerateV1ChatCompletionsRequestToolsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestToolsInner:
        """Test PostGenerateV1ChatCompletionsRequestToolsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestToolsInner`
        """
        model = PostGenerateV1ChatCompletionsRequestToolsInner()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestToolsInner(self):
        """Test PostGenerateV1ChatCompletionsRequestToolsInner"""
