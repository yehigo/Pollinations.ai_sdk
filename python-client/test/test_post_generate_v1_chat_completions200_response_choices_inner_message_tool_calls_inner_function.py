...
class TestPostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInnerFunction(unittest.TestCase):
    """PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInnerFunction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInnerFunction:
        """Test PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInnerFunction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInnerFunction`
        """
        model = PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInnerFunction()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInnerFunction(self):
        """Test PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInnerFunction"""
