...
class TestGetGenerateV1Models200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateV1Models200Response:
        """Test GetGenerateV1Models200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateV1Models200Response`
        """
        model = GetGenerateV1Models200Response()
        if include_optional:
    ...
    def testGetGenerateV1Models200Response(self):
        """Test GetGenerateV1Models200Response"""
