...
class TestPostGenerateV1ChatCompletionsRequestFunctionCall(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestFunctionCall unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestFunctionCall:
        """Test PostGenerateV1ChatCompletionsRequestFunctionCall
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestFunctionCall`
        """
        model = PostGenerateV1ChatCompletionsRequestFunctionCall()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestFunctionCall(self):
        """Test PostGenerateV1ChatCompletionsRequestFunctionCall"""
