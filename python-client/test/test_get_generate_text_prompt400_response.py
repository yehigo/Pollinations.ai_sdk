...
class TestGetGenerateTextPrompt400Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateTextPrompt400Response:
        """Test GetGenerateTextPrompt400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextPrompt400Response`
        """
        model = GetGenerateTextPrompt400Response()
        if include_optional:
    ...
    def testGetGenerateTextPrompt400Response(self):
        """Test GetGenerateTextPrompt400Response"""
