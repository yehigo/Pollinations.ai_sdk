...
class TestGetGenerateV1Models500Response(unittest.TestCase):
    """GetGenerateV1Models500Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateV1Models500Response:
        """Test GetGenerateV1Models500Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateV1Models500Response`
        """
        model = GetGenerateV1Models500Response()
        if include_optional:
            return GetGenerateV1Models500Response(
                status = 500,
                success = false,
                error = PollinationAI_SDK.models.get_generate_v1_models_500_response_error.getGenerateV1Models_500_response_error(
                    code = 'INTERNAL_ERROR', 
                    message = null, 
                    timestamp = '', 
    ...
    def testGetGenerateV1Models500Response(self):
        """Test GetGenerateV1Models500Response"""
