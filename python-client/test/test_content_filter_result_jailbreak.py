...
class TestContentFilterResultJailbreak(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContentFilterResultJailbreak:
        """Test ContentFilterResultJailbreak
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentFilterResultJailbreak`
        """
        model = ContentFilterResultJailbreak()
        if include_optional:
    ...
    def testContentFilterResultJailbreak(self):
        """Test ContentFilterResultJailbreak"""
