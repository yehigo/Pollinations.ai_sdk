...
class TestPostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInnerAnyOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInnerAnyOf:
        """Test PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInnerAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInnerAnyOf`
        """
        model = PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInnerAnyOf()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInnerAnyOf(self):
        """Test PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageContentBlocksInnerAnyOf"""
