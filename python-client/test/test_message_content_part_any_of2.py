...
class TestMessageContentPartAnyOf2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MessageContentPartAnyOf2:
        """Test MessageContentPartAnyOf2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageContentPartAnyOf2`
        """
        model = MessageContentPartAnyOf2()
        if include_optional:
    ...
    def testMessageContentPartAnyOf2(self):
        """Test MessageContentPartAnyOf2"""
