...
class TestGetGenerateTextPrompt402ResponseError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateTextPrompt402ResponseError:
        """Test GetGenerateTextPrompt402ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextPrompt402ResponseError`
        """
        model = GetGenerateTextPrompt402ResponseError()
        if include_optional:
    ...
    def testGetGenerateTextPrompt402ResponseError(self):
        """Test GetGenerateTextPrompt402ResponseError"""
