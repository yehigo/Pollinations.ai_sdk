...
class TestContentFilterResultHate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContentFilterResultHate:
        """Test ContentFilterResultHate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentFilterResultHate`
        """
        model = ContentFilterResultHate()
        if include_optional:
    ...
    def testContentFilterResultHate(self):
        """Test ContentFilterResultHate"""
