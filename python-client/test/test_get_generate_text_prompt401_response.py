...
class TestGetGenerateTextPrompt401Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateTextPrompt401Response:
        """Test GetGenerateTextPrompt401Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextPrompt401Response`
        """
        model = GetGenerateTextPrompt401Response()
        if include_optional:
    ...
    def testGetGenerateTextPrompt401Response(self):
        """Test GetGenerateTextPrompt401Response"""
