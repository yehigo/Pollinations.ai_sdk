...
class TestMessageContentPartAnyOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MessageContentPartAnyOf:
        """Test MessageContentPartAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageContentPartAnyOf`
        """
        model = MessageContentPartAnyOf()
        if include_optional:
    ...
    def testMessageContentPartAnyOf(self):
        """Test MessageContentPartAnyOf"""
