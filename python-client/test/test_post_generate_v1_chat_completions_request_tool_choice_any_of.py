...
class TestPostGenerateV1ChatCompletionsRequestToolChoiceAnyOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf:
        """Test PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf`
        """
        model = PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestToolChoiceAnyOf(self):
        """Test PostGenerateV1ChatCompletionsRequestToolChoiceAnyOf"""
