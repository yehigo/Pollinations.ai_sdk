...
class TestGetGenerateImageModels500ResponseErrorMessage(unittest.TestCase):
    """GetGenerateImageModels500ResponseErrorMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateImageModels500ResponseErrorMessage:
        """Test GetGenerateImageModels500ResponseErrorMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateImageModels500ResponseErrorMessage`
        """
        model = GetGenerateImageModels500ResponseErrorMessage()
        if include_optional:
    ...
    def testGetGenerateImageModels500ResponseErrorMessage(self):
        """Test GetGenerateImageModels500ResponseErrorMessage"""
