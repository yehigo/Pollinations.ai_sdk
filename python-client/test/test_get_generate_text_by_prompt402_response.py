...
class TestGetGenerateTextByPrompt402Response(unittest.TestCase):
    """GetGenerateTextByPrompt402Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextByPrompt402Response:
        """Test GetGenerateTextByPrompt402Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextByPrompt402Response`
        """
        model = GetGenerateTextByPrompt402Response()
        if include_optional:
            return GetGenerateTextByPrompt402Response(
                status = 402,
                success = false,
                error = PollinationAI_SDK.models.get_generate_text_by_prompt_402_response_error.getGenerateTextByPrompt_402_response_error(
    ...
    def testGetGenerateTextByPrompt402Response(self):
        """Test GetGenerateTextByPrompt402Response"""
