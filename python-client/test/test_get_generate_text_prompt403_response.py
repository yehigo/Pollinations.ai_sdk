...
class TestGetGenerateTextPrompt403Response(unittest.TestCase):
    """GetGenerateTextPrompt403Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextPrompt403Response:
        """Test GetGenerateTextPrompt403Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextPrompt403Response`
        """
        model = GetGenerateTextPrompt403Response()
        if include_optional:
            return GetGenerateTextPrompt403Response(
                status = 403,
                success = false,
                error = test.models.get_generate_text_prompt_403_response_error.getGenerateText_prompt_403_response_error(
                    code = 'FORBIDDEN', 
                    message = null, 
                    timestamp = '', 
    ...
    def testGetGenerateTextPrompt403Response(self):
        """Test GetGenerateTextPrompt403Response"""
