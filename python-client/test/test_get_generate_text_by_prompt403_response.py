...
class TestGetGenerateTextByPrompt403Response(unittest.TestCase):
    """GetGenerateTextByPrompt403Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextByPrompt403Response:
        """Test GetGenerateTextByPrompt403Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextByPrompt403Response`
        """
        model = GetGenerateTextByPrompt403Response()
        if include_optional:
            return GetGenerateTextByPrompt403Response(
                status = 403,
                success = false,
                error = PollinationAI_SDK.models.get_generate_text_by_prompt_403_response_error.getGenerateTextByPrompt_403_response_error(
                    code = 'FORBIDDEN', 
                    message = null, 
                    timestamp = '', 
    ...
    def testGetGenerateTextByPrompt403Response(self):
        """Test GetGenerateTextByPrompt403Response"""
