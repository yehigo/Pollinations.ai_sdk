...
class TestPostGenerateV1ChatCompletionsRequestStop(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestStop:
        """Test PostGenerateV1ChatCompletionsRequestStop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestStop`
        """
        model = PostGenerateV1ChatCompletionsRequestStop()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestStop(self):
        """Test PostGenerateV1ChatCompletionsRequestStop"""
