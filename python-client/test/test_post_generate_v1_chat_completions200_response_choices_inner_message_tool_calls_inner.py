...
class TestPostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInner:
        """Test PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInner`
        """
        model = PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInner()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInner(self):
        """Test PostGenerateV1ChatCompletions200ResponseChoicesInnerMessageToolCallsInner"""
