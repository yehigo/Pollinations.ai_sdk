...
class TestPostGenerateV1ChatCompletionsRequestResponseFormatAnyOf(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestResponseFormatAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestResponseFormatAnyOf:
        """Test PostGenerateV1ChatCompletionsRequestResponseFormatAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestResponseFormatAnyOf`
        """
        model = PostGenerateV1ChatCompletionsRequestResponseFormatAnyOf()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestResponseFormatAnyOf(self):
        """Test PostGenerateV1ChatCompletionsRequestResponseFormatAnyOf"""
