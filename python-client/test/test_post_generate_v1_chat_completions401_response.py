...
class TestPostGenerateV1ChatCompletions401Response(unittest.TestCase):
    """PostGenerateV1ChatCompletions401Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletions401Response:
        """Test PostGenerateV1ChatCompletions401Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletions401Response`
        """
        model = PostGenerateV1ChatCompletions401Response()
        if include_optional:
            return PostGenerateV1ChatCompletions401Response(
                status = 401,
                success = false,
                error = test.models.post_generate_v1_chat_completions_401_response_error.postGenerateV1ChatCompletions_401_response_error(
                    code = 'UNAUTHORIZED', 
                    message = null, 
                    timestamp = '', 
    ...
    def testPostGenerateV1ChatCompletions401Response(self):
        """Test PostGenerateV1ChatCompletions401Response"""
