...
class TestPostGenerateV1ChatCompletionsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequest:
        """Test PostGenerateV1ChatCompletionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequest`
        """
        model = PostGenerateV1ChatCompletionsRequest()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequest(self):
        """Test PostGenerateV1ChatCompletionsRequest"""
