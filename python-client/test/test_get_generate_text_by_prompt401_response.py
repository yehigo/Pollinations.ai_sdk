...
class TestGetGenerateTextByPrompt401Response(unittest.TestCase):
    """GetGenerateTextByPrompt401Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextByPrompt401Response:
        """Test GetGenerateTextByPrompt401Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextByPrompt401Response`
        """
        model = GetGenerateTextByPrompt401Response()
        if include_optional:
            return GetGenerateTextByPrompt401Response(
                status = 401,
                success = false,
                error = PollinationAI_SDK.models.get_generate_text_by_prompt_401_response_error.getGenerateTextByPrompt_401_response_error(
                    code = 'UNAUTHORIZED', 
                    message = null, 
                    timestamp = '', 
    ...
    def testGetGenerateTextByPrompt401Response(self):
        """Test GetGenerateTextByPrompt401Response"""
