...
class TestGetGenerateTextByPrompt401ResponseError(unittest.TestCase):
    """GetGenerateTextByPrompt401ResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextByPrompt401ResponseError:
        """Test GetGenerateTextByPrompt401ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextByPrompt401ResponseError`
        """
        model = GetGenerateTextByPrompt401ResponseError()
        if include_optional:
    ...
    def testGetGenerateTextByPrompt401ResponseError(self):
        """Test GetGenerateTextByPrompt401ResponseError"""
