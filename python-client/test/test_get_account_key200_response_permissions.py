...
class TestGetAccountKey200ResponsePermissions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAccountKey200ResponsePermissions:
        """Test GetAccountKey200ResponsePermissions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccountKey200ResponsePermissions`
        """
        model = GetAccountKey200ResponsePermissions()
        if include_optional:
    ...
    def testGetAccountKey200ResponsePermissions(self):
        """Test GetAccountKey200ResponsePermissions"""
