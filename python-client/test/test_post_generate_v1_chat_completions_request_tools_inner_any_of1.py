...
class TestPostGenerateV1ChatCompletionsRequestToolsInnerAnyOf1(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf1:
        """Test PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf1`
        """
        model = PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf1()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestToolsInnerAnyOf1(self):
        """Test PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf1"""
