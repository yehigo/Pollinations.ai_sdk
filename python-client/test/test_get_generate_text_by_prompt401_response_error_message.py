...
class TestGetGenerateTextByPrompt401ResponseErrorMessage(unittest.TestCase):
    """GetGenerateTextByPrompt401ResponseErrorMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextByPrompt401ResponseErrorMessage:
        """Test GetGenerateTextByPrompt401ResponseErrorMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextByPrompt401ResponseErrorMessage`
        """
        model = GetGenerateTextByPrompt401ResponseErrorMessage()
        if include_optional:
    ...
    def testGetGenerateTextByPrompt401ResponseErrorMessage(self):
        """Test GetGenerateTextByPrompt401ResponseErrorMessage"""
