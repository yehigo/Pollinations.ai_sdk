...
class TestGetGenerateV1Models200ResponseDataInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateV1Models200ResponseDataInner:
        """Test GetGenerateV1Models200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateV1Models200ResponseDataInner`
        """
        model = GetGenerateV1Models200ResponseDataInner()
        if include_optional:
    ...
    def testGetGenerateV1Models200ResponseDataInner(self):
        """Test GetGenerateV1Models200ResponseDataInner"""
