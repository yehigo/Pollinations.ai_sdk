...
class TestMessageContentPartAnyOf1InputAudio(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MessageContentPartAnyOf1InputAudio:
        """Test MessageContentPartAnyOf1InputAudio
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageContentPartAnyOf1InputAudio`
        """
        model = MessageContentPartAnyOf1InputAudio()
        if include_optional:
    ...
    def testMessageContentPartAnyOf1InputAudio(self):
        """Test MessageContentPartAnyOf1InputAudio"""
