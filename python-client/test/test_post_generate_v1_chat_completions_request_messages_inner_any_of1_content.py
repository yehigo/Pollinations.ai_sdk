...
class TestPostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content:
        """Test PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content`
        """
        model = PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content(self):
        """Test PostGenerateV1ChatCompletionsRequestMessagesInnerAnyOf1Content"""
