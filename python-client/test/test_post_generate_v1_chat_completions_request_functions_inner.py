...
class TestPostGenerateV1ChatCompletionsRequestFunctionsInner(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestFunctionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestFunctionsInner:
        """Test PostGenerateV1ChatCompletionsRequestFunctionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestFunctionsInner`
        """
        model = PostGenerateV1ChatCompletionsRequestFunctionsInner()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestFunctionsInner(self):
        """Test PostGenerateV1ChatCompletionsRequestFunctionsInner"""
