...
class TestPostGenerateV1ChatCompletionsRequestToolsInnerAnyOf(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf:
        """Test PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf`
        """
        model = PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestToolsInnerAnyOf(self):
        """Test PostGenerateV1ChatCompletionsRequestToolsInnerAnyOf"""
