...
class TestGetGenerateTextPrompt401ResponseErrorMessage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateTextPrompt401ResponseErrorMessage:
        """Test GetGenerateTextPrompt401ResponseErrorMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextPrompt401ResponseErrorMessage`
        """
        model = GetGenerateTextPrompt401ResponseErrorMessage()
        if include_optional:
    ...
    def testGetGenerateTextPrompt401ResponseErrorMessage(self):
        """Test GetGenerateTextPrompt401ResponseErrorMessage"""
