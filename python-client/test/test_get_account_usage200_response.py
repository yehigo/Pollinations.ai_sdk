...
class TestGetAccountUsage200Response(unittest.TestCase):
    """GetAccountUsage200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAccountUsage200Response:
        """Test GetAccountUsage200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccountUsage200Response`
        """
        model = GetAccountUsage200Response()
        if include_optional:
            return GetAccountUsage200Response(
                usage = [
                    test.models.get_account_usage_200_response_usage_inner.getAccountUsage_200_response_usage_inner(
                        timestamp = '', 
                        type = '', 
                        model = '', 
                        api_key = '', 
    ...
    def testGetAccountUsage200Response(self):
        """Test GetAccountUsage200Response"""
