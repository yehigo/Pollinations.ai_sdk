...
class TestGetGenerateV1Models500ResponseErrorMessage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateV1Models500ResponseErrorMessage:
        """Test GetGenerateV1Models500ResponseErrorMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateV1Models500ResponseErrorMessage`
        """
        model = GetGenerateV1Models500ResponseErrorMessage()
        if include_optional:
    ...
    def testGetGenerateV1Models500ResponseErrorMessage(self):
        """Test GetGenerateV1Models500ResponseErrorMessage"""
