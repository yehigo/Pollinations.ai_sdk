...
class TestGetGenerateTextPrompt401ResponseError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateTextPrompt401ResponseError:
        """Test GetGenerateTextPrompt401ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextPrompt401ResponseError`
        """
        model = GetGenerateTextPrompt401ResponseError()
        if include_optional:
    ...
    def testGetGenerateTextPrompt401ResponseError(self):
        """Test GetGenerateTextPrompt401ResponseError"""
