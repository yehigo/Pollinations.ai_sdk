...
class TestPostGenerateV1ChatCompletionsRequestMessagesInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestMessagesInner:
        """Test PostGenerateV1ChatCompletionsRequestMessagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestMessagesInner`
        """
        model = PostGenerateV1ChatCompletionsRequestMessagesInner()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestMessagesInner(self):
        """Test PostGenerateV1ChatCompletionsRequestMessagesInner"""
