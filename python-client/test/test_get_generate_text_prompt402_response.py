...
class TestGetGenerateTextPrompt402Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGenerateTextPrompt402Response:
        """Test GetGenerateTextPrompt402Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextPrompt402Response`
        """
        model = GetGenerateTextPrompt402Response()
        if include_optional:
    ...
    def testGetGenerateTextPrompt402Response(self):
        """Test GetGenerateTextPrompt402Response"""
