...
class TestPostGenerateV1ChatCompletions200ResponseChoicesInnerMessage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletions200ResponseChoicesInnerMessage:
        """Test PostGenerateV1ChatCompletions200ResponseChoicesInnerMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletions200ResponseChoicesInnerMessage`
        """
        model = PostGenerateV1ChatCompletions200ResponseChoicesInnerMessage()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletions200ResponseChoicesInnerMessage(self):
        """Test PostGenerateV1ChatCompletions200ResponseChoicesInnerMessage"""
