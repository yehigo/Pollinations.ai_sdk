...
class TestPostGenerateV1ChatCompletions403Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletions403Response:
        """Test PostGenerateV1ChatCompletions403Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletions403Response`
        """
        model = PostGenerateV1ChatCompletions403Response()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletions403Response(self):
        """Test PostGenerateV1ChatCompletions403Response"""
