...
class TestPostGenerateV1ChatCompletionsRequestFunctionCallAnyOf(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf:
        """Test PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf`
        """
        model = PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestFunctionCallAnyOf(self):
        """Test PostGenerateV1ChatCompletionsRequestFunctionCallAnyOf"""
