...
class TestPostGenerateV1ChatCompletions200ResponsePromptFilterResultsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletions200ResponsePromptFilterResultsInner:
        """Test PostGenerateV1ChatCompletions200ResponsePromptFilterResultsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletions200ResponsePromptFilterResultsInner`
        """
        model = PostGenerateV1ChatCompletions200ResponsePromptFilterResultsInner()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletions200ResponsePromptFilterResultsInner(self):
        """Test PostGenerateV1ChatCompletions200ResponsePromptFilterResultsInner"""
