...
class TestGetGenerateTextPrompt402ResponseErrorMessage(unittest.TestCase):
    """GetGenerateTextPrompt402ResponseErrorMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGenerateTextPrompt402ResponseErrorMessage:
        """Test GetGenerateTextPrompt402ResponseErrorMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGenerateTextPrompt402ResponseErrorMessage`
        """
        model = GetGenerateTextPrompt402ResponseErrorMessage()
        if include_optional:
    ...
    def testGetGenerateTextPrompt402ResponseErrorMessage(self):
        """Test GetGenerateTextPrompt402ResponseErrorMessage"""
