...
class TestPostGenerateV1ChatCompletionsRequestResponseFormatAnyOf1JsonSchema(unittest.TestCase):
    """PostGenerateV1ChatCompletionsRequestResponseFormatAnyOf1JsonSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostGenerateV1ChatCompletionsRequestResponseFormatAnyOf1JsonSchema:
        """Test PostGenerateV1ChatCompletionsRequestResponseFormatAnyOf1JsonSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostGenerateV1ChatCompletionsRequestResponseFormatAnyOf1JsonSchema`
        """
        model = PostGenerateV1ChatCompletionsRequestResponseFormatAnyOf1JsonSchema()
        if include_optional:
    ...
    def testPostGenerateV1ChatCompletionsRequestResponseFormatAnyOf1JsonSchema(self):
        """Test PostGenerateV1ChatCompletionsRequestResponseFormatAnyOf1JsonSchema"""
