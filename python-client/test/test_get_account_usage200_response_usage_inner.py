...
class TestGetAccountUsage200ResponseUsageInner(unittest.TestCase):
    """GetAccountUsage200ResponseUsageInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAccountUsage200ResponseUsageInner:
        """Test GetAccountUsage200ResponseUsageInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccountUsage200ResponseUsageInner`
        """
        model = GetAccountUsage200ResponseUsageInner()
        if include_optional:
            return GetAccountUsage200ResponseUsageInner(
                ...
                api_key_type = '',
                meter_source = '',
                input_text_tokens = 1.337,
                input_cached_tokens = 1.337,
                input_audio_tokens = 1.337,
                input_image_tokens = 1.337,
                output_text_tokens = 1.337,
                output_reasoning_tokens = 1.337,
                output_audio_tokens = 1.337,
                output_image_tokens = 1.337,
                cost_usd = 1.337,
    ...
    def testGetAccountUsage200ResponseUsageInner(self):
        """Test GetAccountUsage200ResponseUsageInner"""
